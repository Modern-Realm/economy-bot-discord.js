...
const columns = [
    "wallet", "bank"
]; // You can add more Columns in it ! 

const conn = mysql2.createConnection({
    host: Auth.DB_HOST, port: Auth.DB_PORT,
    user: Auth.DB_USER, password: Auth.DB_PASSWD,
...
async function create_table() {
    await DB.execute(`CREATE TABLE IF NOT EXISTS ${TABLE_NAME}(userID VARCHAR(100) PRIMARY KEY)`);
...
module.exports = {
    DB,
    create_table,
    open_bank, get_bank_data, update_bank,
    get_networth_lb
}
